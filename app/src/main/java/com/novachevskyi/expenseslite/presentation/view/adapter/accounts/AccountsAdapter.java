...
public class AccountsAdapter extends RecyclerView.Adapter<AccountsAdapter.AccountViewHolder> {
  ...
  public AccountsAdapter(Context context, Collection<AccountModel> accountsCollection) {
  ...
  @Override public AccountViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    if (this.layoutInflater != null) {
      View view = this.layoutInflater.inflate(R.layout.recycler_view_item_account, parent, false);
  ...
  @Override public void onBindViewHolder(AccountViewHolder holder, final int position) {
    ...
    holder.tv_amount.setText(String.format(
        context.getString(R.string.adapter_accounts_amount_text_template),
    ...
    holder.rl_details.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        if (AccountsAdapter.this.onItemClickListener != null) {
          AccountsAdapter.this.onItemClickListener.onAccountItemClicked(accountModel);
        }
      }
    });
  }
